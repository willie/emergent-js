  ...
  return (
    <div className="flex flex-col gap-1 mt-2 transition-all">
      <button
        ...
        className="text-zinc-500 hover:text-blue-400 transition-colors p-1 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none rounded"
        title="Edit message"
      >
        <EditIcon />
      </button>
      <button
        ...
        className="text-zinc-500 hover:text-red-400 transition-colors p-1 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none rounded"
      ...
      <button
        ...
        className="text-zinc-500 hover:text-zinc-300 transition-colors p-1 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none rounded"
