...
// Optimization: Hoisted ReactMarkdown configuration to module scope
// to prevent object recreation on every render. This ensures that
// ReactMarkdown receives stable props and can be memoized effectively.
