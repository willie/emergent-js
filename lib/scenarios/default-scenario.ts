    ...
    characters: [
        {
            ...
            encounterChance: 1,
            goals: 'To learn the secrets of this town.',
        },
        {
            name: 'Maya',
            ...
            initialLocationName: 'Coffee Shop',
            encounterChance: 0.9,
            goals: 'To decode the ancient texts she found.',
        },
        {
            name: 'Alex',
            ...
            initialLocationName: 'Coffee Shop',
            encounterChance: 0.9,
            goals: 'To protect the neutrality of the coffee shop.',
        },
        {
            name: 'Marcus',
            ...
            encounterChance: 0.8,
            goals: 'To communicate with the birds who see everything.',
        },
        {
            name: 'Elena',
            ...
            encounterChance: 0.7,
            goals: 'To keep the forbidden knowledge in the basement secure.',
        },
        {
            name: 'Jay',
            ...
            encounterChance: 0.5,
            goals: 'To avoid being found by the people chasing them.',
        },
    ],
};
